 ...
 * @author Joan Fabrégat <joan@codeinc.fr>
 */
class DirectoryClassesIteratorTest extends TestCase
{
    public const ASSETS_PATH = RecursiveDirectoryClassesIteratorTest::ASSETS_PATH;

    public function testListing():void
    {
        $iterator = new DirectoryClassesIterator(self::ASSETS_PATH);
        ...
        $this->assertArrayNotHasKey(AnotherSubClass::class, $classes);
        ...
        $this->assertNotContains(__DIR__.'/Assets/SubFolder/AnotherSubClass.php', $classes);
    ...
    {
        $iterator = new DirectoryClassesIterator(self::ASSETS_PATH, ['inc']);
        $this->assertInstanceOf(\Traversable::class, $iterator);
        $classes = [];
        foreach ($iterator as $class) {
            $this->assertTrue(
    ...
    {
        $iterator = new DirectoryClassesIterator(self::ASSETS_PATH, ['inc', 'php']);
        $this->assertInstanceOf(\Traversable::class, $iterator);
        $classes = [];
        foreach ($iterator as $class) {
            $this->assertTrue(
